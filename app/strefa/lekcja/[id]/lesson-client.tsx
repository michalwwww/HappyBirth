...
import { getLessonById, getAdjacentLessons, getLessonsByStage, getStageById } from '@/lib/course-data';
...
interface StrefaLessonClientProps {
  lessonId: string;
}

export default function StrefaLessonClient({ lessonId }: StrefaLessonClientProps) {
